...
namespace ClubManager
{
    public partial class FrmMenu : Form, IOberverIdioma
    {
        ...
        private void ConfigurarMenuPrincipal()
        {
            ...
            menuStrip1.BackColor = Color.FromArgb(75, 12, 24);
        ...
        private void ConfigurarSelectorIdiomaMenu()
        {
            try
            {
                ...
                if (TratamientoIdioma.Instancia.IdiomaActual != null)
                {
                    cmbIdiomaMenu.SelectedValue = TratamientoIdioma.Instancia.IdiomaActual.Id;
                }
        ...
        private void ConfigurarPanelPrincipal()
        {
            ...
            panelAccesos.Padding = new Padding(45, 45, 45, 45);
            ...
            subtitulo.Margin = new Padding(0, 0, 0, 22);
        ...
        private void AgregarResumenInsigniasSocioPleno()
        {
            try
            {
                ...
                panelInsignias.Width = 860;
                panelInsignias.Height = 152;
                ...
                panelInsignias.Margin = new Padding(0, 0, 0, 16);
        ...
        private Panel CrearTarjetaInsigniaResumen(DataRow fila)
        {
            ...
            nivel.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            ...
            progreso.Width = 98;
            progreso.Height = 34;
            progreso.Font = new Font("Segoe UI", 7.5F, FontStyle.Regular);
            ...
            estado.Font = new Font("Segoe UI", 8F, FontStyle.Bold);
        ...
        private void AgregarSeparadorPanel()
        {
            ...
            separador.Width = 860;
            separador.Height = 10;
            separador.Margin = new Padding(0, 6, 0, 6);
        ...
        {
            AbrirFormularioHijo(new FrmModuloClub("Insignias"));
        }
